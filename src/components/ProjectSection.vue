<template>
  <section class="text-white mt-20 lg:min-h-[450px]" id="projects">
    <div class="px-4 xl:pl-16">
      <div class="mb-4 md:flex md:justify-between xl:pr-16">
        <h2 class="text-4xl font-bold text-white">My Latest Projects</h2>
        <div class="flex space-x-4 mb-4 mt-5 md:mt-0">
          <button
            v-for="category in ['All', 'Fullstack', 'Frontend']"
            class="hover:text-[#f59e0b] transition ease-in-out z-10 cursor-pointer duration-300"
            :key="category"
      ...
      >
        <div v-for="project in filteredProjects" :key="project.id">
          ...
          >
            ...
            <div class="flex flex-wrap py-2.5 gap-2">
              <div
                v-for="technology in project.technologies"
                :key="technology"
                class="text-center rounded-2xl bg-[#111827] px-1.5"
                style="
...
import Cyber from "@/assets/CyberShop.png";
...
const Projects = ref([
  {
    ...
    gitURL: "https://github.com/Teehim00/merry_match_project",
    webURL: "https://merry-match-project.vercel.app/",
  },
  {
    id: 2,
    category: "Fullstack",
    ...
    gitURL: "https://github.com/TongBud44/reangsak-personal-blog",
    webURL: "https://reangsak-personal-blog.vercel.app/",
  },
  {
    id: 3,
    category: "Frontend",
    ...
    gitURL: "https://github.com/TongBud44/my-portfolio",
    webURL: "https://my-portfolio-seven-gamma-79.vercel.app/",
  },
  {
    id: 4,
    category: "Frontend",
    image: Cyber,
    title: "Cyber Shop (Ongoing)",
    description:
      "An e-commerce platform for an IT shop offering a seamless shopping experience, where customers can easily browse and purchase tech products. The site is responsive and optimized for both desktop and mobile.",
    technologies: ["Vue.js", "Tailwind CSS"],
    gitURL: "",
    webURL: "",
  },
